...
const rehearsalSteps = [
  ...
  "Open the assigned patient record.",
  "Review a permitted record category and its source.",
  ...
  "Read records from the other hospital after approval.",
  "Stop sharing and confirm further access is denied.",
  "Activate the bounded emergency summary when eligible.",
  "Request one additional record category, explain why, and check the expiry.",
