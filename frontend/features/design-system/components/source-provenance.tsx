import { ArrowUpRightIcon, ClockIcon, DatabaseIcon, FingerprintIcon } from "@phosphor-icons/react";
...
export function SourceProvenance({
  ...
  return (
    <dl className="grid gap-2 border-t border-border/70 pt-3 text-xs text-muted-foreground sm:grid-cols-2">
      ...
      <div className="flex min-w-0 items-center gap-2">
        <FingerprintIcon aria-hidden="true" className="size-3.5 shrink-0 text-primary" />
