...
import {
  ...
  type ConsentRequestStatusCollection,
  type ExchangeDomain,
...
function RequestStatusPanel({ requests }: { requests: ReturnType<typeof useConsentRequests> }) {
